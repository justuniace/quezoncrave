...
export function DinnerModal({ onClose, dinner }) {
  ...
  const imageUrl = urlFor(dinner.image).url();
        ...
        <Modal isCentered isOpen onClose={onClose} motionPreset="slideInBottom">
          ...
          <ModalContent>
            <ModalHeader>
              ...
              >
                <Image src={imageUrl} alt={dinner.name} w="15rem" h="18rem" />
              </Flex>
            ...
            <ModalBody margin="0 20px">
              ...
              <HStack>
                ...
                <Text fontSize="12px">{dinner.rating}</Text>
                <Text fontSize="12px">( {dinner.people} )</Text>
              </HStack>
