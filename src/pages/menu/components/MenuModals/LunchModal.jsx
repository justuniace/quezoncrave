...
export function LunchModal({ onClose, lunch }) {
  ...
  const imageUrl = urlFor(lunch.image).url();
        ...
        <Modal isCentered isOpen onClose={onClose} motionPreset="slideInBottom">
          ...
          <ModalContent>
            <ModalHeader>
              ...
              >
                <Image src={imageUrl} alt={lunch.name} w="15rem" h="18rem" />
              </Flex>
            ...
            <ModalBody margin="0 20px">
              ...
              <HStack>
                ...
                <Text fontSize="12px">{lunch.rating}</Text>
                <Text fontSize="12px">( {lunch.people} )</Text>
              </HStack>
